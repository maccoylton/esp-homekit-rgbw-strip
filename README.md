...
Use the GPIO buttons to change the GPIOs for each colour, note each value must not be equal to any other value, changes wil be applied 5 seconds after you change a GPIO. Sp if you need to change more than one, just make all the changes and then wait 5 seconds
